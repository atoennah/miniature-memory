...
# Modular imports from the project's scripts
...
# The training script is imported dynamically to keep CLI args clean.
...
def main():
    ...
    This refactored script orchestrates the pipeline by calling functions
    directly, eliminating the overhead of subprocesses.
    """
    ...
    # Execute pipeline steps as direct function calls
    ...
    if not args.skip_training:
        ...
        try:
            ...
            print(f"Error: Could not import training module. {e}", file=sys.stderr)
