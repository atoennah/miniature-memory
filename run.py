...
# Bolt ⚡: Import the refactored, modular pipeline functions
from scripts.validate_raw import validate
from scripts.clean_dataset import clean
...
def main():
    ...
    # Bolt ⚡: Add arguments for data directories to restore configurability.
    parser.add_argument(
        "--raw-dir",
        type=str,
        default="dataset/raw",
    ...
    # Bolt ⚡: Execute the pipeline as a series of direct function calls,
    # passing the configured directories to each stage.
    if not args.skip_validation:
        print("--- Running Validation ---")
        validate(raw_data_dir=args.raw_dir)
        print("--- Validation completed successfully ---\n")

    if not args.skip_cleaning:
        print("--- Running Cleaning ---")
        clean(raw_dir=args.raw_dir, cleaned_dir=args.cleaned_dir)
        print("--- Cleaning completed successfully ---\n")

    if not args.skip_preparation:
        print("--- Running Preparation ---")
        prepare(cleaned_dir=args.cleaned_dir, processed_dir=args.processed_dir)
