...
class FeedForward(nn.Module):
    ...
    def __init__(self, config: GPTConfig):
        ...
        self.net = nn.Sequential(
            # [BOLT] Optimization: GPT-2 paper found that biases in projection layers
            # can be safely removed without impacting model quality. This is now controlled
            # by the `bias` flag in the model configuration.
