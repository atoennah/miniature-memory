...
class Trainer:
    ...
    def _build_optimizer(self) -> torch.optim.Optimizer:
        ...
        # Filter sets to only include parameters actually present in named_parameters()
        # This handles tied weights where multiple names might point to the same tensor
