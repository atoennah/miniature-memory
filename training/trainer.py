...
class Trainer:
    ...
    def _build_optimizer(self) -> torch.optim.Optimizer:
        ...
        # Filter decay/no_decay to only include parameters that actually exist in param_dict
        # This handles weight tying where multiple module parameters point to the same tensor
