...
class Trainer:
    ...
    def _build_optimizer(self) -> torch.optim.Optimizer:
        ...
        # Filter sets to only include parameters that are actually in the model's named_parameters.
        # This handles tied weights where multiple names might refer to the same parameter,
