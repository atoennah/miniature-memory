...
Before diving into the file-level details, it is highly recommended to read the **[System Architecture guide](ARCHITECTURE.md)** for a high-level overview of the project's design and data flow.
